...
/*   Updated: 2023/10/25 21:47:49 by daleliev         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_search(const char f, va_list ap)
{
	...
	len = 0;
	if (f == 'c')
		len = ft_putchar_fd((char) va_arg(ap, int));
	else if (f == 's')
		len = ft_putstr_fd(va_arg(ap, char *));
	else if (f == 'p')
		len = ft_printp(va_arg(ap, void *), len, 1);
	else if (f == 'd' || f == 'i')
		len = ft_putnbr_fd((long long)va_arg(ap, int), len);
	else if (f == 'u')
